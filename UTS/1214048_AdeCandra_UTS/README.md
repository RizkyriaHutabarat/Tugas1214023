# PROSES TAHAPAN DALAM MEMBUAT DATA BACKEND

1. langkah pertama yang saya lakukan dalam membuat backend adalah membuat backend package (seperti pada week4)
...
```
git tag
git tag v0.0.3 // sesuaikan dengan versi terbaru
git push origin --tags
go list -m github.com/AdeCandra12/surat@v0.0.3
```

# PROSES TAHAPAN DALAM MEMBUAT DATA FRONTEND

1. Setelah selesai membuat backend, selanjutnya saya membuat frontend.
2. frontend sudah pernah dibuat pada week 6(boilerpltate), kita tambahkan function Get, dan GetAll di coba.go. ini source codenya:
...
3. setelah itu, tambahkan variable di db.go untuk memanggil database surat_db. berikut source codenya.
...
4. kemudian, tambahkan juga page pada url.go

```
page.Get("/surat", controller.GetAllSurat)
page.Get("/disposisi", controller.GetAllDisposisi)
```
...
12. controller yang berisi get.js. ini source codenya
...
13. temp yang berisi table.js dan fetch.js. ini source code dari table.js dan fetch.js:
...
14. setelah itu kita edit pada folder template yang telah kita dowmload.
15. di dalam folder template terdapat index.html. disana kita tambahkan source code

```
  <script type="module" src="../../js/fetch.js"></script>
```

16. untuk edit tables.html, berikut source codenya:
        ...
        <ul>
          ...
          <li class="relative px-6 py-3">
            ...
            <a class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100"
              ...
              <span class="ml-4">Tabel surat</span>
            </a>
          </li>
          <li class="relative px-6 py-3">
            <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg"
            ...
            <a class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100"
              ...
              <span class="ml-4">Tabel disposisi</span>
            </a>
          </li>
          <li class="relative px-6 py-3">
            <button
        ...
        <div class="container grid px-6 mx-auto">
          ...
          <div class="w-full mb-8 overflow-hidden rounded-lg shadow-xs">
            <div class="w-full overflow-x-auto">
              <table id="iniTabel" class="w-full whitespace-no-wrap">
                <thead>
                  <tr
...
17. karena saya memanggil 2 table, saya membuat file baru bernama tables2.html dengan source code:
    ...
    <div class="flex flex-col flex-1 w-full">
      ...
      <main class="h-full pb-16 overflow-y-auto">
        <div class="container grid px-6 mx-auto">
          ...
          <div class="w-full mb-8 overflow-hidden rounded-lg shadow-xs">
            <div class="w-full overflow-x-auto">
              <table id="iniTabelDis" class="w-full whitespace-no-wrap">
                <thead>
                  <tr
                    class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                    <th class="px-4 py-3">kode disposisi</th>
                    <th class="px-4 py-3">tanggal disposisi</th>
                    <th class="px-4 py-3">penerima surat</th>
